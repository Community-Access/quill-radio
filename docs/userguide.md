...
- **Import Stations...** -- pick a JSON station list (the simple name/category/stream-address arrays accessible radio apps commonly use, or one you built yourself) and it merges into your favorites: categories become folders, duplicates are skipped, and nothing you already have is ever overwritten.
